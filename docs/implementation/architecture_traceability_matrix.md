...
| MUT-01 | Strategy/Code/Balance boundaries, bounded structured retries, and authoritative mutation inputs | mutation | `eagle/mutation.py`, `eagle/rewrite.py`, `eagle/strategy_reflection.py` | mutation/reflection tests | Implemented |
