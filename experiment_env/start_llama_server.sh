...
# Compatibility search path for previously downloaded models in this experiment env.
EAGLE_MODEL_DIR="${EAGLE_MODEL_DIR:-$ROOT_DIR/model}"
...
Environment overrides:
  ...
  EAGLE_MODEL_DIR=/path/to/experiment_env/model
