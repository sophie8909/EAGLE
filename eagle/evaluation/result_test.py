...
# CLI examples:
# `py -m eagle.evaluation.result_test --log-dir logs/20260409_123456 --generation 20`
#   Replay only Pareto Front 1 from generation 20.
#
# `py -m eagle.evaluation.result_test --log-dir logs/20260409_123456 --generation 20 --max-front 3`
#   Replay Pareto Front 1, 2, and 3 from generation 20.
#
# `py -m eagle.evaluation.result_test --log-dir logs/20260409_123456 --generation 20 --all-fronts`
#   Replay every individual stored in generation 20.
#
# `py -m eagle.evaluation.result_test --log-dir logs/20260409_123456 --generation 20 --individual-id <id>`
#   Replay only one specific individual from generation 20.
#
# `py -m eagle.evaluation.result_test --log-dir logs/20260409_123456 --generation 20 --opponent ai.RandomAI --opponent ai.PassiveAI`
