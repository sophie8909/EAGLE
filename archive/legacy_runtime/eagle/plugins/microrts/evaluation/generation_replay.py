...
from eagle.project import DEFAULT_FINAL_TEST_CONFIG_PATH
...
# `py -m eagle.plugins.microrts.evaluation.generation_replay --log-dir logs/eagle/20260409_123456 --generation 20 --config configs/evaluation/final_test.json`
