 ...
 */
public class HybridLLMRush extends AbstractionLayerAI {
    ...
    private static final int LLM_INTERVAL =
            Integer.parseInt(System.getenv().getOrDefault("HYBRID_LLM_INTERVAL", "200"));
     ...
     */
    public HybridLLMRush(UnitTypeTable a_utt) {
     ...
     */
    public HybridLLMRush(UnitTypeTable a_utt, PathFinding a_pf) {
        super(a_pf);
        reset(a_utt);
    }
    ...
    public void reset(UnitTypeTable a_utt) {
        ...
        System.out.println("[HybridLLMRush] Initialized with model=" + MODEL +
                           ", interval=" + LLM_INTERVAL + ", initial_strategy=" + currentStrategy);
    }

    @Override
    public AI clone() {
        HybridLLMRush clone = new HybridLLMRush(utt, pf);
    ...
    private void switchStrategy(RushStrategy newStrategy, int currentTime) {
        System.out.println("[HybridLLMRush] T=" + currentTime + ": Strategy switch " +
    ...
    private RushStrategy consultLLMForStrategy(int player, GameState gs) {
        ...
        try {
            ...
            llmErrors++;
            System.err.println("[HybridLLMRush] LLM consultation failed: " + e.getMessage());
    ...
    private RushStrategy parseStrategyResponse(String response) {
        ...
        System.out.println("[HybridLLMRush] Could not parse strategy from: " + response);
        return null;
    }
    ...
    public String toString() {
        return "HybridLLMRush(model=" + MODEL + ", strategy=" + currentStrategy +
