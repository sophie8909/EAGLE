...
- Reusable native template: `Meeting/template/Meeting_0830_Template.potx`
...
- Native template theme: `PMingLiU` / 新細明體 for Latin, East Asian, and complex-script slots. Preserve explicit serif heading emphasis; do not silently swap fonts. The originals have strong heading weight, so inspect the actual rendered font appearance.
