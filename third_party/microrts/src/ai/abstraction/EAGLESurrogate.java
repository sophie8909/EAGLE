...
public class EAGLESurrogate extends AbstractionLayerAI {
    ...
    private static final String[] EMBEDDED_PROMPT_LINES = {
        ...
        "Maintain relentless pressure by adapting to state-based conditions, triggering early/mid/late transitions as necessary to dictate tempo and seize initiative through aggressive expansion with minimal passive waiting.",
        "EARLY GAME PLAN:",
        "Prioritize ruthless economy disruption through surprise attacks on key infrastructure, such as harvesting paths and unfinished buildings.",
        "Target exposed enemy workers to disrupt supply chains and force the opponent to react aggressively.",
        "Maintain a strong presence at home to dictate tempo while the opponent is forced to divert resources to respond to your relentless aggression.",
        "Seamlessly transition into mid game by adapting state-based conditions over rigid turn thresholds, ensuring continuous pressure and aggressive expansion with minimal passive waiting.",
        "MID GAME PLAN:",
        "Apply ruthless economy disruption by targeting exposed enemy workers and unfinished buildings, disrupting supply chains and forcing the opponent to react aggressively.",
        "Adapt state-based conditions over rigid turn thresholds to maintain a high-pressure stance, integrating economy disruption with unit flow to collapse key infrastructure and force decisive engagement through relentless aggression.",
        "LATE GAME PLAN:",
        "Once economies are heavily disrupted and infrastructure is severely damaged, each unit's utility supersedes long-term scaling advantages.",
        "Coordinated pressure should converge on key enemy assets instead of dispersing into low-value pursuits.",
        "In a base race scenario, prioritize actions that rapidly conclude the game over preserving minimum required structures for sustaining prolonged engagement.",
        "DECISION PRIORITY:",
        "1. Prioritize early/mid game plan adaptations to disrupt enemy economies through relentless aggression, targeting key infrastructure such as workers, unfinished buildings, and harvesting paths.",
        "2. Continuously exploit exposed enemy units to force the opponent into reactive measures, preventing long-term stabilization and seizing initiative.",
        "3. Refocus on high-value movement that improves contact, defense, or economic pressure while maintaining a delicate balance between economy disruption and unit flow.",
        "4. Transition to late game plan adaptations once economies are heavily disrupted and infrastructure is severely damaged, converging coordinated pressure on key enemy assets instead of dispersing into low-value pursuits.",
        "5. Prioritize actions that rapidly conclude the game over preserving minimum required structures for sustaining prolonged engagement.",
        "TACTICAL HEURISTICS:",
