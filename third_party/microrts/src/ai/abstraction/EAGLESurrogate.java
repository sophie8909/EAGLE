...
public class EAGLESurrogate extends AbstractionLayerAI {
    ...
    private static final String[] EMBEDDED_PROMPT_LINES = {
        ...
        "STRATEGY IDENTITY: Aggressive expansion.",
        "Prioritize swift conquest of key resources, aggressive unit deployment, and rapid transition to all-out warfare before opponents can establish a strong economy or defense.",
        "Risk tolerance is high throughout: aggressively seek out and exploit enemy weaknesses at every opportunity.",
        "Pressure timing is immediate once any credible threat emerges, regardless of income or production stability.",
        "Preferred win path is to overwhelm the opponent through relentless aggression and forceful pressure rather than building an economic lead.",
        "PHASE TRANSITION RULE:",
        "Treat the game as early while key resources are significantly underdeveloped: gold, food, or production capacity is insufficient to sustain immediate warfare capability.",
        "Treat the game as mid once both sides have established credible warfare capability, demonstrated by aggressive pressure around key assets such as resource nodes, production facilities, or strategic structures.",
        "Treat the game as late when core infrastructure, including bases, barracks, and worker counts, has been severely damaged or threatened, necessitating decisive endgame pressure to ensure survival.",
        "Prefer observed army strength, structure count, and local threat level over rigid turn thresholds, adapting strategy_identity's aggressive expansion approach to maintain momentum and forceful pressure throughout the game.",
        "EARLY GAME PLAN:",
        "Aggressively expand with rapid unit deployment and structure construction, prioritizing swift conquest of key resources to force an early transition into all-out warfare before opponents can establish a secure economy or robust defense.",
        "MID GAME PLAN:",
        "Prioritize swift transition to all-out warfare by rapidly pressuring key assets such as resource nodes, production facilities, or strategic structures. Maintain aggressive unit deployment and structure construction while adapting strategy_identity's approach to pressure the opponent's economy and defense simultaneously. Focus on collapsing the enemy system with coordinated pressure rather than spreading into low-value chases, favoring actions that end the enemy faster or preserve the minimum structure needed to win.",
        "LATE GAME PLAN:",
        "Prioritize decisive endgame pressure by collapsing on key assets such as resource nodes, production facilities, or strategic structures with coordinated attacks rather than splitting forces into low-value chases.",
        "In a base race, favor actions that end the enemy faster or preserve the minimum structure needed to win.",
        "DECISION PRIORITY:",
        "1. Immediately address any existing combat threats with priority to resolving units already in combat or about to be hit.",
        "2. Preserve favorable local trades by focusing on resource conversion and unit production without disrupting economic efficiency.",
        "3. Allocate resources promptly for useful workers, barracks, and combat units to maintain momentum and forceful pressure throughout the game.",
        "4. Prioritize adapting strategy_identity's aggressive expansion approach over purely economic considerations to ensure swift transition to all-out warfare.",
        "5. Optimize formation, pressure angle, or map access in real-time to minimize losses and maximize impact on the opponent's economy and defense.",
        "TACTICAL HEURISTICS:",
