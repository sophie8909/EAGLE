...
class Mutation:
    ...
    def _build_rewrite_instruction(
        ...
        *,
        ...
        domain_guidance = cls._domain_rewrite_guidance(component_pool)
    ...
    def _build_static_rewrite_instruction(
        ...
        *,
        ...
        return (
            ...
            "- Preserve coherence with the rest of the prompt.\n"
    ...
    @staticmethod
    def _domain_rewrite_guidance(component_pool: ComponentPool) -> str:
