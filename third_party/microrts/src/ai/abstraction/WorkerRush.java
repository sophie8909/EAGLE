            ...
            if (harvestWorker.getResources() > 0) {
                if (closestBase != null) {
                    ...
                    if (aa instanceof Harvest) {
                        Harvest harvestAction = (Harvest) aa;
                        if (harvestAction.base != closestBase) harvest(harvestWorker, null, closestBase);
                    } else {
                ...
                if (aa instanceof Harvest) {
                    Harvest harvestAction = (Harvest) aa;
                    if (harvestAction.target != closestResource || harvestAction.base != closestBase) {
