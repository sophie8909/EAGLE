...
policy prompt, Prompt rewrote the generation prompt, or Code diagnosed and then
directly revised the selected parent Java. Text/source equality never determines
